...
const socialLinks = [
  ...
  {
    label: "Email", href: "mailto:hello@knowsamvidhan.in",
...
export default function FooterSection() {
  ...
  const handleSubmit = () => { if (rating > 0) setSubmitted(true); };
  ...
  return (
    <footer className="relative overflow-hidden bg-[#0a0a0f]">
      ...
      {/* ── Ambient glow blobs ── */}
      <div className="pointer-events-none absolute -top-28 -left-28 h-[300px] w-[300px] sm:h-[400px] sm:w-[400px] rounded-full bg-[radial-gradient(circle,rgba(249,115,22,0.07)_0%,transparent_70%)]" />
      <div className="pointer-events-none absolute -bottom-20 -right-20 h-[240px] w-[240px] sm:h-[320px] sm:w-[320px] rounded-full bg-[radial-gradient(circle,rgba(251,191,36,0.05)_0%,transparent_70%)]" />
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[200px] w-[90vw] sm:w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(ellipse,rgba(249,115,22,0.03)_0%,transparent_70%)]" />
      ...
      <div className="pointer-events-none select-none absolute bottom-16 right-[-30px] opacity-[0.025] hidden md:block">
        <img src="/image/ashoka.png" alt="" width={280} height={280} aria-hidden="true" />
      </div>
      ...
      {/* ══════════════════════════════════════════ MAIN ══════════════════════════ */}
      <div className="relative z-10 mx-auto max-w-[1280px] px-4 pt-10 sm:px-6 sm:pt-12 lg:px-8 lg:pt-14">

        {/* ── Stats bar ── */}
        <div className="mb-10 sm:mb-12 lg:mb-14 flex overflow-hidden rounded-xl sm:rounded-2xl border border-orange-500/15 bg-orange-500/[0.03]">
          {stats.map((s, i) => (
            <div
              key={s.label}
              className={`flex-1 px-1 py-3 sm:px-2 sm:py-4 text-center transition-colors duration-200 hover:bg-orange-500/[0.06] ${
                i < stats.length - 1 ? "border-r border-orange-500/10" : ""
              }`}
            >
              <div className="bg-gradient-to-br from-orange-500 to-amber-400 bg-clip-text text-[18px] xs:text-[20px] sm:text-[22px] font-black leading-none text-transparent [font-family:'Playfair_Display',serif]">
                {s.value}
              </div>
        ...
        <div className="mb-10 sm:mb-12 lg:mb-14 grid grid-cols-1 gap-8 min-[480px]:grid-cols-2 md:grid-cols-[1.4fr_0.8fr_0.8fr] lg:grid-cols-[1.6fr_1fr_1fr_1.8fr] min-[480px]:gap-x-8 min-[480px]:gap-y-8">
          ...
          <div className="col-span-1 min-[480px]:col-span-2 md:col-span-1 lg:col-span-1">
            <div className="mb-4 sm:mb-5 flex items-center gap-3">
              <div className="h-10 w-10 sm:h-11 sm:w-11 shrink-0 overflow-hidden rounded-full border border-orange-500/40 bg-white">
                <img src="/image/logo.png" alt="KnowSamvidhan logo" className="h-full w-full object-cover" />
              </div>
              <div>
            ...
            <p className="mb-5 sm:mb-6 max-w-full sm:max-w-[340px] lg:max-w-[300px] text-[13px] leading-[1.85] text-gray-500">
            ...
            <div className="flex gap-2">
              {socialLinks.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="flex h-9 w-9 items-center justify-center rounded-[10px] border border-white/[0.08] bg-white/[0.04] text-gray-500 transition-all duration-200 hover:-translate-y-0.5 hover:border-orange-500/40 hover:bg-orange-500/[0.12] hover:text-orange-500 hover:shadow-[0_8px_20px_rgba(249,115,22,0.2)]"
                >
                  {s.icon}
                </a>
              ))}
            ...
            <div className="flex flex-col gap-0.5">
              {exploreLinks.map((item) => (
                <Link
                  key={item.label}
                  href={item.href}
                  className="group flex items-center gap-2 border-b border-transparent py-[5px] text-[13px] text-gray-500 transition-all duration-200 hover:border-orange-500/30 hover:text-orange-500 no-underline"
                >
          ...
          <div className="col-span-1 min-[480px]:col-span-2 md:col-span-3 lg:col-span-1">
            ...
            {/* Card */}
            <div className="relative overflow-hidden rounded-[16px] sm:rounded-[20px] border border-orange-500/[0.18] bg-gradient-to-br from-orange-500/[0.06] to-[#0a0a0f]/80 p-5 sm:p-6 lg:p-8">
              {/* top shimmer */}
              ...
              {submitted ? (
                ...
                <div className="flex flex-col items-center justify-center gap-3 py-4 sm:py-6 text-center">
                  <div className="flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full border border-orange-500/30 bg-gradient-to-br from-orange-500/20 to-amber-400/10">
                  ...
                  <div className="text-base sm:text-lg font-bold text-slate-100 [font-family:'Playfair_Display',serif]">
                    Thank you!
                  </div>
                  ...
                  <button
                    onClick={() => { setSubmitted(false); setRating(0); setComment(""); setName(""); }}
                ...
                <div className="flex flex-col gap-3 sm:gap-4">
                  <div>
                    <div className="mb-1 text-[15px] sm:text-[17px] font-bold text-slate-100 [font-family:'Playfair_Display',serif]">
                  ...
                  <div className="flex items-center justify-between gap-3 flex-wrap">
                    <button
                      ...
                      className="inline-flex items-center gap-2 rounded-[10px] bg-gradient-to-br from-orange-500 to-orange-600 px-4 sm:px-5 py-2.5 text-[13px] font-semibold text-white shadow-[0_4px_16px_rgba(249,115,22,0.3)] transition-all duration-200 enabled:hover:-translate-y-0.5 enabled:hover:shadow-[0_8px_24px_rgba(249,115,22,0.45)] disabled:cursor-not-allowed disabled:opacity-40"
                    >
                    ...
                    {rating === 0 && (
                      <span className="text-[11px] text-gray-600">Select a star to submit</span>
                    )}
                  </div>
                </div>
              )}
        ...
        {/* ══════════════════════════════════════════ BOTTOM BAR ════════════════ */}
        <div className="flex flex-col gap-3 border-t border-white/[0.05] py-5 text-xs text-gray-600 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col gap-2 min-[480px]:flex-row min-[480px]:flex-wrap min-[480px]:items-center min-[480px]:gap-x-4 min-[480px]:gap-y-2">
            ...
            <a
              ...
              className="inline-flex w-fit items-center gap-1.5 rounded-full border border-orange-500/20 bg-orange-500/[0.08] px-3 py-1 text-[11px] text-gray-400 no-underline transition-all duration-200 hover:border-orange-500/40 hover:bg-orange-500/[0.14] hover:text-orange-500"
            >
              {/* Animated heart */}
              <svg
