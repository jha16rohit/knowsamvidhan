...
import { Mail, Lock, ArrowRight, ShieldCheck, BookOpen } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row font-sans">
      ...
      <div className="w-full md:w-1/2 bg-[#0a0f18] text-white flex flex-col p-10 md:p-16 lg:p-24 relative overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#c19d60]/10 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="flex items-center gap-3 z-10">
          ...
          <div>
            ...
            <p className="text-[9px] tracking-[0.25em] text-gray-400 mt-0.5">
            ...
            <form onSubmit={handleLogin} className="text-left space-y-5">
              ...
              <div>
                ...
                <div className="flex justify-end mt-2">
                  <a
                    href="/admin-xyz/forgot-password"
